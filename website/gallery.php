<div class="w3-row-padding w3-padding-32" style="margin:0 -16px">
    ...
    <div class="w3-third w3-margin-bottom">
        <img src="img/portfolio/project1/thumbnails/!cover.jpeg" alt="Project 1" style="width:100%" class="w3-hover-opacity">
    ...
    <div class="w3-third w3-margin-bottom">
        <img src="img/portfolio/project3/thumbnails/!cover.jpeg" alt="Project 3" style="width:100%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
            <p><b>Project 3</b></p>
    ...
    <div class="w3-third w3-margin-bottom">
        <img src="img/portfolio/project4/thumbnails/!cover.jpeg" alt="Project 4" style="width:100%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
            <p><b>Project 4</b></p>
            <p class="w3-opacity">Sun 29 Nov 2016</p>
            <p>LOCATION, PA.</p>
    ...
    <div class="w3-third w3-margin-bottom">
        <img src="img/portfolio/project5/thumbnails/!cover.jpeg" alt="Project 5" style="width:100%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
            <p><b>Project 5</b></p>
            <p class="w3-opacity">Sun 29 Nov 2016</p>
            <p>LOCATION, PA.</p>
    ...
    <div class="w3-third w3-margin-bottom">
        <img src="img/portfolio/project6/thumbnails/!cover.jpeg" alt="Project 6" style="width:100%" class="w3-hover-opacity">
        <div class="w3-container w3-white">
            <p><b>Project 6</b></p>
            <p class="w3-opacity">Sun 29 Nov 2016</p>
            <p>LOCATION, PA.</p>
